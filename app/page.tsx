...
function TiltCard({ children, className = '' }: { children: React.ReactNode, className?: string }) {
  ...
  return (
    ...
    >
      {/* 
        This inner div creates the actual 3D pop effect. 
        Items inside will seem to float above the card background. 
      */}
      ...
      <main className="pt-16">
        ...
        <section className="relative min-h-[90vh] flex flex-col lg:flex-row items-center justify-between pt-20 pb-20 px-4 md:px-12 max-w-[1400px] mx-auto overflow-hidden">
          ...
          <div className="relative z-10 space-y-6 w-full lg:w-1/2 text-center lg:text-left mt-10 lg:mt-0 order-2 lg:order-1">
            <h2 className="text-zinc-400 font-medium tracking-widest uppercase text-sm">
              Promaroc Pro
            </h2>
          ...
          <div className="relative z-10 w-full lg:w-1/2 h-[50vh] lg:h-[80vh] order-1 lg:order-2 cursor-grab active:cursor-grabbing">
            <Canvas camera={{ position: [5, 2, 6], fov: 45 }}>
              ...
              {/* PresentationControls allows the user to drag and spin the model slightly without losing it */}
        ...
        <section className="py-32 px-4 md:px-8 max-w-7xl mx-auto space-y-8 relative z-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 perspective-[2000px]">
            ...
            <TiltCard className="md:col-span-2 bg-gradient-to-br from-zinc-900 to-black rounded-[2.5rem] p-10 md:p-14 border border-zinc-800 relative overflow-hidden group">
            ...
            {/* Feature 2: Small Box */}
            <TiltCard className="bg-zinc-900 rounded-[2.5rem] p-10 border border-zinc-800 relative overflow-hidden">
            ...
            {/* Feature 3: Small Box */}
            <TiltCard className="bg-zinc-900 rounded-[2.5rem] p-10 border border-zinc-800">
              <div className="flex flex-col justify-center h-full min-h-[300px]">
