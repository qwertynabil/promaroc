  ...
  return (
    <div className="text-promaroc-black dark:text-promaroc-white animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-sora font-bold mb-2">My Listings</h1>
        ...
        <Link
          href="/dashboard/hosting/properties/new"
      ...
      {properties.length === 0 ? (
        <div className="bg-white dark:bg-white/5 border border-black/5 dark:border-white/10 p-16 rounded-3xl text-center shadow-sm max-w-2xl mx-auto mt-12">
          ...
          <h3 className="text-2xl font-sora font-bold mb-3">
            No listings yet
          </h3>

          <p className="text-black/50 dark:text-white/50 mb-8 text-lg">
            Your property portfolio is empty. List your first property to start
            welcoming guests.
          </p>

          <Link
            href="/dashboard/hosting/properties/new"
            className="bg-promaroc-black text-promaroc-white dark:bg-promaroc-white dark:text-promaroc-black px-8 py-3.5 rounded-xl font-bold hover:scale-105 transition-all inline-block"
          >
            Create a listing
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {properties.map((property: any) => (
            <div
              key={property.id}
              className="bg-white dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group flex flex-col"
            >
              <div className="w-full h-48 bg-black/5 dark:bg-white/5 relative overflow-hidden shrink-0">
                ...
                <div className="absolute top-4 right-4">
                  <span
                    className={`px-3 py-1.5 rounded-full text-[10px] font-bold tracking-wider uppercase backdrop-blur-md ${
                      property.status === "APPROVED"
                        ? "bg-promaroc-green/90 text-white"
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <h3 className="text-xl font-bold font-sora mb-2 line-clamp-1 group-hover:text-promaroc-green transition-colors">
                  {property.title}
                </h3>
